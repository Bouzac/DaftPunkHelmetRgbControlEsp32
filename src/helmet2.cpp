...
// Service: LED Control
static const char* BLE_SVC_LEDCTRL = "98765432-1234-5678-1234-56789abcdef0";
// Characteristics
static const char* BLE_CH_MODE       = "98765432-1234-5678-1234-56789abcdef1"; // uint8: 0=text,1=lighting
static const char* BLE_CH_SUBMODE    = "98765432-1234-5678-1234-56789abcdef2"; // uint8
static const char* BLE_CH_BRIGHT     = "98765432-1234-5678-1234-56789abcdef3"; // uint8 1..255
static const char* BLE_CH_TEXTSPD    = "98765432-1234-5678-1234-56789abcdef4"; // uint16 (ms)
static const char* BLE_CH_EFFSPD     = "98765432-1234-5678-1234-56789abcdef5"; // uint16 (ms)
static const char* BLE_CH_COLOR      = "98765432-1234-5678-1234-56789abcdef6"; // 3 bytes RGB
static const char* BLE_CH_TEXT       = "98765432-1234-5678-1234-56789abcdef7"; // UTF-8 text (<=180 bytes recommended)
...
void setup() {
  ...
  adv->start();
  Serial.println("BLE ready! Advertised as DaftPunkHelmetB");
}
